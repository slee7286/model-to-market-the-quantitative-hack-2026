...
| Exit threshold | 0.15 | Finals update after stored signal replay favored faster exits; supersedes the qualification sprint `0.75` value. Coarse-grid candidate: 0.05, 0.10, 0.15, 0.25, 0.35, 0.5, 0.75. |
